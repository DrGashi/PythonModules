...
st.write("This app analises the Amazon Best Selling books from the year 2009 to 2022")
...
fig = px.bar(size, x='Year', y='Counts', title='Number of Fiction vs Non-Fiction', color='Genre', color_discrete_sequence=px.colors.sequential.Plasma)
st.plotly_chart(fig)